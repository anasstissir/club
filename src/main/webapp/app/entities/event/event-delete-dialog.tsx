...
export const EventDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clubManagmentApp.event.delete.question">Are you sure you want to delete this Event?</ModalBody>
      <ModalFooter>
