...
import { getEntity, deleteEntity } from './meeting.reducer';

export const MeetingDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clubManagmentApp.meeting.delete.question">Are you sure you want to delete this Meeting?</ModalBody>
      <ModalFooter>
