...
export const Meeting = (props: RouteComponentProps<{ url: string }>) => {
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('meetingDate')}>
                  Meeting Date <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('meetingPlace')}>
                  Meeting Place <FontAwesomeIcon icon="sort" />
                </th>
                <th>
