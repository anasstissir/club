  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          clubs: studentEntity?.clubs?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clubManagmentApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Club" id="student-club" data-cy="club" type="select" multiple name="clubs">
                <option value="" key="0" />
                {clubs
