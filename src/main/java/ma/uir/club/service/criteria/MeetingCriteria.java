...
/**
 * Criteria class for the {@link ma.uir.club.domain.Meeting} entity. This class is used
 * in {@link ma.uir.club.web.rest.MeetingResource} to receive all the possible filtering options from
...
public class MeetingCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, meetingDate, meetingPlace, clubId, distinct);
    }
