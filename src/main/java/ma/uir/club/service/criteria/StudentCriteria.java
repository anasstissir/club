package ma.uir.club.service.criteria;
...
/**
 * Criteria class for the {@link ma.uir.club.domain.Student} entity. This class is used
 * in {@link ma.uir.club.web.rest.StudentResource} to receive all the possible filtering options from
...
public class StudentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstname, lastname, nationality, city, filiere, level, residency, tel, mail, userId, clubId, distinct);
    }
