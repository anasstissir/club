...
/**
 * Criteria class for the {@link ma.uir.club.domain.Event} entity. This class is used
 * in {@link ma.uir.club.web.rest.EventResource} to receive all the possible filtering options from
...
public class EventCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, eventDate, eventEnd, eventPlace, budget, clubId, distinct);
    }
