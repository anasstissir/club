...
/**
 * Criteria class for the {@link ma.uir.club.domain.Club} entity. This class is used
 * in {@link ma.uir.club.web.rest.ClubResource} to receive all the possible filtering options from
...
public class ClubCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, clubName, creationDate, studentId, distinct);
    }
