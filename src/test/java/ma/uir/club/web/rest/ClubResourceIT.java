...
class ClubResourceIT {
    ...
    public static Club createEntity(EntityManager em) {
        Club club = new Club().clubName(DEFAULT_CLUB_NAME).creationDate(DEFAULT_CREATION_DATE);
        return club;
    }
    ...
    public static Club createUpdatedEntity(EntityManager em) {
        Club club = new Club().clubName(UPDATED_CLUB_NAME).creationDate(UPDATED_CREATION_DATE);
        return club;
    }
    ...
    @Test
    @Transactional
    void getAllClubsByStudentIsEqualToSomething() throws Exception {
        // Initialize the database
        clubRepository.saveAndFlush(club);
        Student student;
        ...
        // Get all the clubList where student equals to studentId
        defaultClubShouldBeFound("studentId.equals=" + studentId);

        // Get all the clubList where student equals to (studentId + 1)
        defaultClubShouldNotBeFound("studentId.equals=" + (studentId + 1));
    }
    ...
    void putNewClub() throws Exception {
        ...
        updatedClub.clubName(UPDATED_CLUB_NAME).creationDate(UPDATED_CREATION_DATE);
    ...
    void fullUpdateClubWithPatch() throws Exception {
        ...
        partialUpdatedClub.clubName(UPDATED_CLUB_NAME).creationDate(UPDATED_CREATION_DATE);
